...
import type { TransitionType, SlideElement, TextContent, IconBulletContent, StatCardContent, TimelineNodeContent, ComparisonRowContent, QuoteBlockContent, ImageContent } from '@/types'
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h4 className="text-sm font-semibold text-stone-900">
          {element.type === 'text' && (content.variant === 'heading' ? '标题文本' :
           content.variant === 'subheading' ? '副标题文本' :
           content.variant === 'caption' ? '注释文本' : '正文文本')}
      ...
      {content.html !== undefined && (
        <div className="space-y-3">
          <div>
            <label className="block text-xs font-semibold text-stone-500 uppercase tracking-wider mb-1">HTML 源码</label>
            <textarea
              value={content.html}
          ...
          <div>
            <label className="block text-xs font-semibold text-stone-500 uppercase tracking-wider mb-1">CSS 样式</label>
            <textarea
              value={content.css}
      ...
      {/* Callout editor */}
      {content.variant !== undefined && content.title !== undefined && content.body !== undefined && content.quote === undefined && (
        <div className="space-y-3">
          <div>
      ...
      {content.items !== undefined && !content.tags && (
        <div className="space-y-3">
          <label className="block text-xs font-semibold text-stone-500 uppercase tracking-wider">术语表</label>
          {(content.items as { term: string; definition: string }[]).map((item: { term: string; definition: string }, i: number) => (
  ...
  return (
    <div className="w-72 flex-shrink-0 bg-surface border-l border-stone-200/60 flex flex-col overflow-hidden">
      <div className="p-4 border-b border-stone-100">
        ...
        {selectedElement && (
          <p className="text-xs text-stone-400 mt-1">点击幻灯片元素进行编辑</p>
        )}
      </div>
          ...
          <>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => updateSlideField(currentSlide.id, 'transitionType', e.target.value as TransitionType)}
                className="w-full px-3 py-2 rounded-lg border border-stone-200 text-sm text-stone-700
                           bg-white focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => updateSlideField(currentSlide.id, 'duration', parseInt(e.target.value) || 0)}
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => updateSlideField(currentSlide.id, 'backgroundColor', e.target.value)}
